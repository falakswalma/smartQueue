    ...
    <div className="p-4">
      <Tabs defaultValue="details" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="practice">Previous work Info</TabsTrigger>
        ...
        <TabsContent value="details">
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              <div className="flex items-center">
                <span className="mr-3">License :</span>
        ...
        <TabsContent value="practice">
          <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              <div className="flex items-center">
                <span className="mr-3">Previous job Name :</span>
              ...
              <div className="flex items-center">
                <span className="mr-3">Hours of work :</span>
                <span>{doctorProfile?.hospitalHoursOfOperation}</span>
              </div>
              <div className="flex items-center">
                <span className="mr-3">Hobbies :</span>
            ...
            <div className="py-4 space-y-4">
              ...
              <div className="flex items-center">
                <span className="mr-3">Website address :</span>
